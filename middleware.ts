...
export const config = {
  matcher: ['/((?!_next/static|_next/image|favicon.ico|manifest.json|sw.js|icon-192.png|icon-512.png|logo/|api/pdf|api/send-email|api/contract-pdf-gen|api/places|api/estimate-pdf).*)'],
}
