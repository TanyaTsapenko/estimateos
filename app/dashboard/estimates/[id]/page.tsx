...
interface Opening {
  ...
  screen: boolean | null; tilt_clean: boolean | null; opening_direction: string | null
        ...
        <div className="est-3col">
                ...
                <div style={{ display: 'flex' }}>
                  ...
                  <div style={{ flex: 1, padding: '10px 12px' }}>
                    ...
                    {(() => {
                      ...
                      if (op.screen) pills.push(<span key="screen" style={{ background: '#EFF4FF', borderRadius: 5, padding: '2px 8px', fontSize: 10, color: '#2563EB', border: '0.5px solid #BFDBFE' }}>Screen ✓</span>)
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10, padding: '14px 0' }}>
            ...
            <div style={{ ...CARD, overflow: 'hidden' }}>
              ...
              {[
                { icon: <FileDown       size={15} color="#64748B" />, label: 'Download Estimate PDF',          onClick: () => window.location.href = `/api/estimate-pdf?id=${id}`,    danger: false, show: true },
