...
export function welcomeEmailHtml(
  ...
  const logoHtml = logoUrl
    ? `<table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 22px;"><tr><td><img src="${logoUrl}" style="height:44px;max-width:160px;display:block;object-fit:contain;" alt="${companyName || 'ApexScale'}" /></td></tr></table>`
