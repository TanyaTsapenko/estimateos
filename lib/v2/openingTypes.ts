    ...
    types: {
      ...
      slider: { name: 'Slider', subs: ['XO','OX','XX','End vent','Double end vent','Lift-out'],
        fields: ['width','height','qty','room','floor',
          'extColour','intColour','grid','grilleType',
          ...W_COMMON_GLASS, ...W_COMMON_INSTALL,
          'screen','screenCoverage','numPanels','egress','photos','notes'],
      ...
      singleHung: { name: 'Single hung', subs: ['Standard','Tilt-In'],
        fields: ['width','height','qty','room','floor',
          'extColour','intColour','grid','grilleType',
          ...W_COMMON_GLASS, ...W_COMMON_INSTALL,
          'shape','screen','ventLock','photos','notes'],
      ...
      doubleHung: { name: 'Double hung', subs: ['Standard','Tilt-in'],
        fields: ['width','height','qty','room','floor',
          ...
          ...W_COMMON_GLASS, ...W_COMMON_INSTALL,
          'screen','topSashOperable','bottomSashOperable','egress','photos','notes'],
        extraFieldsBySubtype: { 'Tilt-in': ['tiltClean'] } },
    ...
    types: {
      entry: { name: 'Entry door', subs: ['Single door','Left sidelite','Right sidelite','Double sidelite','Transom'],
        fields: ['width','height','qty',
          'doorSwing','doorStyle','doorExt','doorInt',
          'sidelights','transomAbove','glassInsert','laminatedGlass',
          'doorMaterial','locksetBore','lockset','deadbolt','hwColour',
          'thresholdType','brickmould','jamb','install','condition',
          'photos','notes'] },
      ...
      doubleEntry: { name: 'Double entry', subs: ['Equal double','Unequal double'],
        fields: ['width','height','qty',
          'doorSwing','doorStyle','doorExt','doorInt',
          'sidelights','transomAbove','glassInsert','laminatedGlass',
          'doorMaterial','lockset','deadbolt','hwColour',
          'thresholdType','brickmould','jamb',
          'photos','notes'] },

      french: { name: 'French door', subs: ['Single french','Double french','French + sidelites'],
        fields: ['width','height','qty',
          'doorSwing','sidelights','glassInsert','laminatedGlass',
          'grid','doorMaterial','hwColour','lockset',
          'thresholdType','photos','notes'],
        extraFieldsBySubtype: {
      ...
      garden: { name: 'Garden door', subs: ['In-swing','Out-swing'],
        fields: ['width','height','qty',
          'doorSwing','activePanel','glassInsert','laminatedGlass',
          'grid','doorMaterial','hwColour',
          'sidelights','transomAbove','thresholdType',
          'photos','notes'] },
      ...
      patio: { name: 'Patio sliding', subs: ['XO','OX','XOX','OXXO'],
        fields: ['width','height','qty',
          ...
          'extColour','intColour',
          'glassType','pane','lowE','tempered','argon','laminatedGlass',
          'glassInsert','material','screen','hwColour',
          'thresholdType','photos','notes'] },

      storm: { name: 'Storm door', subs: ['Full glass','Half glass','Screen'],
        fields: ['width','height','qty',
          'doorSwing','glassType','colour',
          'glassInsert','laminatedGlass',
          'hwColour','screen','closerType',
          'thresholdType','photos','notes'] },
      ...
      interior: { name: 'Interior door', subs: ['Single','Double','Pocket','Bifold'],
        fields: ['width','height','qty',
          'doorSwing','doorStyle','doorExt','doorInt',
          'glassInsert','laminatedGlass',
          'coreType','doorMaterial','lockset','hwColour',
          'thresholdType','photos','notes'] },
    },
  },
}
